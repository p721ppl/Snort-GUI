...
treeViewRl=ttk.Treeview(frameRl,columns=['columnActn','columnProt','columnSrcIPAdd','columnSrcPtNo','columnDirOpr','columnDestIPAdd','columnDestPtNo','columnMsg','columnRefIdSys',
'columnRefId','columnGId','columnSId','columnRev','columnClTp','columnPri'],show='headings')
treeViewRl.heading('columnActn',text='Action')
treeViewRl.column('columnActn',width=40)
